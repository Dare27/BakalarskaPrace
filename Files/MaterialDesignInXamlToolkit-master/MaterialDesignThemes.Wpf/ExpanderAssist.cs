...
namespace MaterialDesignThemes.Wpf
{
    ...
    {
        private static readonly Thickness DefaultHorizontalHeaderPadding = new Thickness(8, 8, 8, 8);
        private static readonly Thickness DefaultVerticalHeaderPadding = new Thickness(8, 8, 8, 8);
